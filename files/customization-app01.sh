...
then
    ...
    echo "hostname:    app01" >> $FILE_CUSTOMIZATION
    echo "ipaddress:   $app_01_ip" >> $FILE_CUSTOMIZATION
    echo "netprefix:   $netmask" >> $FILE_CUSTOMIZATION
    echo "gateway      $app_gw" >> $FILE_CUSTOMIZATION
    ...
    echo "$app_01_ip        logic-ip" >> /etc/hosts
    #
    #
    # Networking settings
    #
