...
then
    ...
    echo "hostname:    web01" >> $FILE_CUSTOMIZATION
    echo "ipaddress:   $web_01_ip" >> $FILE_CUSTOMIZATION
    echo "netprefix:   $netmask" >> $FILE_CUSTOMIZATION
    echo "gateway      $web_gw" >> $FILE_CUSTOMIZATION
